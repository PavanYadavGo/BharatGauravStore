    ...
    return (
        <div className="max-w-5xl mx-auto p-6 text-gray-800">
            ...
            <p className="mb-4">
                ...
                that you have purchased through our Platform. Under this policy:
            </p>

            <ol className="list-decimal pl-6 space-y-4 mb-6">
                <li>
                    Cancellations will only be considered if the request is made within <strong>10 days</strong> of placing the
                    order. However, cancellation requests may not be entertained if the orders have been communicated to
                ...
                <li>
                    <strong>BHARATGAURAV Hair Accessories</strong> does not accept cancellation requests for perishable items
                    like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes
                ...
                <li>
                    ...
                    determined the same at its own end. This should be reported within <strong>10 days</strong> of receipt of
                    products.
                </li>
                <li>
                    In case you feel that the product received is not as shown on the site or as per your expectations,
                    you must bring it to the notice of our customer service within <strong>10 days</strong> of receiving the
                ...
                <li>
                    ...
                    for the refund to be credited to your orignal payment method.
                </li>
            </ol>
